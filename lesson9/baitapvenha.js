...
// return null
// }
// console.log(findUserById(12))

// // ý 2
// function findEmailByKey(){
//     for(let user of users){
//         if()
//     }
// }
...
// // Lọc các user có tên chứa keyword và lấy ra email của họ
...
// // ý 3
// const usersOver50 = users.filter(user => user.age > 50);
// const numUsersOver50 = usersOver50.length;
// console.log(numUsersOver50);


// // ý 4
// const userMarried= users.filter(user => user.is_married ==true);
// const numUserMarried = userMarried.length;
// const userNotMarried= users.filter(user => user.is_married ==false);
// const numNotUserMarried = userNotMarried.length;
// console.log("số người đã kết hôn là: "+numUserMarried);
// console.log("số người chưa kết hôn là: " +numNotUserMarried);

// // ý 5

// const filterJob = users.reduce(function (counts, user) {  // (count,user) => {}, 
//     counts[user.job] = (counts[user.job] || 0) + 1;
//     return counts;
//   }, {});
...
// bài 2
  ...
  console.log(checkDate(21, 1, 2002));
  console.log("ffgg"+Date())
